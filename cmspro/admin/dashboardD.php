...
?>
											...
											<a href="cmspro\admin\manage-users.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
$department=$query3->rowCount();
?>												
													<div class="stat-panel-number h1 "><?php echo htmlentities($department);?></div>
